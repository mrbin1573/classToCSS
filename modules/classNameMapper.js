...
const SEPECIAL_REG = `\[\w+\]` // 特殊值[]

const classNameMapper = [
  // padding
  { matchReg: eval(`/^p-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `padding: ${val * ratio}${unit};`, placeholder: "number" },
  { matchReg: eval(`/^pt-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `padding-top: ${val * ratio}${unit};`, placeholder: "number" },
  { matchReg: eval(`/^pr-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `padding-right: ${val * ratio}${unit};`, placeholder: "number" },
  { matchReg: eval(`/^pb-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `padding-bottom: ${val * ratio}${unit};`, placeholder: "number" },
  { matchReg: eval(`/^pl-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `padding-left: ${val * ratio}${unit};`, placeholder: "number" },
  { matchReg: eval(`/^px-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `padding-left: ${val * ratio}${unit}; padding-right: ${val * ratio}${unit};`, placeholder: "number" },
  { matchReg: eval(`/^py-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `padding-top: ${val * ratio}${unit}; padding-bottom: ${val * ratio}${unit};`, placeholder: "number" },

  // margin
  { matchReg: eval(`/^m-(${MINUS_NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `margin: ${val * ratio}${unit};`, placeholder: "number" },
  { matchReg: eval(`/^mt-(${MINUS_NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `margin-top: ${val * ratio}${unit};`, placeholder: "number" },
  { matchReg: eval(`/^mr-(${MINUS_NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `margin-right: ${val * ratio}${unit};`, placeholder: "number" },
  { matchReg: eval(`/^mb-(${MINUS_NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `margin-bottom: ${val * ratio}${unit};`, placeholder: "number" },
  { matchReg: eval(`/^ml-(${MINUS_NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `margin-left: ${val * ratio}${unit};`, placeholder: "number" },
  { matchReg: eval(`/^mx-(${MINUS_NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `margin-left: ${val * ratio}${unit}; margin-right: ${val * ratio}${unit};`, placeholder: "number" },
  { matchReg: eval(`/^my-(${MINUS_NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `margin-top: ${val * ratio}${unit}; margin-bottom: ${val * ratio}${unit};`, placeholder: "number" },

  // 宽高
  { matchReg: eval(`/^w-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `width: ${val * ratio}${unit};`, placeholder: "number" },
  { matchReg: eval(`/^h-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `height: ${val * ratio}${unit};`, placeholder: "number" },
  ...
  { matchReg: eval(`/^max-w-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `max-width: ${val * ratio}${unit};`, placeholder: "number" },
  { matchReg: eval(`/^max-h-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `max-height: ${val * ratio}${unit};`, placeholder: "number" },
  { matchReg: eval(`/^min-w-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `min-width: ${val * ratio}${unit};`, placeholder: "number" },
  { matchReg: eval(`/^min-h-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `min-height: ${val * ratio}${unit};`, placeholder: "number" },

  // position
  { matchReg: eval(`/^(static|relative|absolute|fixed|sticky)$/`), wrapper: ({ val }) => `position: ${val};`, placeholder: "string" },

  // Top / Right / Bottom / Left
  { matchReg: eval(`/^top-(${MINUS_NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `top: ${val * ratio}${unit};`, placeholder: "string" },
  { matchReg: eval(`/^right-(${MINUS_NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `right: ${val * ratio}${unit};`, placeholder: "string" },
  { matchReg: eval(`/^bottom-(${MINUS_NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `bottom: ${val * ratio}${unit};`, placeholder: "string" },
  { matchReg: eval(`/^left-(${MINUS_NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `left: ${val * ratio}${unit};`, placeholder: "string" },

  // z-index
  { matchReg: eval(`/^z-(${MINUS_NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `z-index: ${val};`, placeholder: "string" },
  ...
  { matchReg: eval(`/^float-(none|left|right|inlineleft|inline-right|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `float: ${val};`, placeholder: "string" },

  // overflow
  { matchReg: eval(`/^overflow-(visible|hidden|scroll|auto|overlay|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `overflow: ${val};`, placeholder: "string" },
  { matchReg: eval(`/^overflow-x-(visible|hidden|scroll|auto|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `overflow-x: ${val};`, placeholder: "string" },
  { matchReg: eval(`/^overflow-y-(visible|hidden|scroll|auto|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `overflow-y: ${val};`, placeholder: "string" },
  ...
  // visibility
  { matchReg: eval(`/^visibility-(hidden|visible|collapse|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `visibility: ${val};`, placeholder: "string" },
  ...
  // flex direction
  { matchReg: eval(`/^flex-(row|row-reverse|column|column-reverse|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `flex-direction: ${val};`, placeholder: "string" },
  ...
  // justify content
  { matchReg: eval(`/^justify-(center|start|end|flex-start|flex-end|left|right|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `justify-content: ${val};`, placeholder: "string" },
  ...
  // justify items
  { matchReg: eval(`/^justify-items-(center|start|end|flex-start|flex-end|left|right|start|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `justify-items: ${val};`, placeholder: "string" },

  // justify self
  { matchReg: eval(`/^justify-self-(center|start|end|stretcht|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `justify-self: ${val};`, placeholder: "string" },

  // align items
  { matchReg: eval(`/^items-(center|start|end|flex-start|flex-end|self-start|self-end|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `align-items: ${val};`, placeholder: "string" },

  // align content
  { matchReg: eval(`/^content-(center|start|end|flex-start|flex-end|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `align-content: ${val};`, placeholder: "string" },

  // align self
  { matchReg: eval(`/^self-(auto|normal|center|stretcht|self-start|self-end|flex-start|flex-end|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `align-self: ${val};`, placeholder: "string" },

  // flex wrap
  { matchReg: eval(`/^flex-(wrap|wrap-reverse|nowrap|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `flex-wrap: ${val};`, placeholder: "string" },
  ...
  // order
  { matchReg: eval(`/^order-(${MINUS_NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `order: ${val};`, placeholder: "string" },

  // font size
  { matchReg: eval(`/^(font-size|fs)-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), valIndex: 2, wrapper: ({ val, ratio = 1, unit = "" }) => `font-size: ${val * ratio}${unit};`, placeholder: "string" },

  // font weight
  { matchReg: eval(`/^(font-weight|fw)-(${HUNDRED_REG}|${SEPECIAL_REG})$/`), valIndex: 2, wrapper: ({ val }) => `font-weight: ${val};`, placeholder: "string" },

  // font family
  { matchReg: eval(`/^(font-family|ff)-(\\S+|${SEPECIAL_REG})$/`), valIndex: 2, wrapper: ({ val }) => `font-family: ${val};`, placeholder: "string" },

  // font style
  { matchReg: eval(`/^font-style-(italic|oblique|normal|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `font-style: ${val};`, placeholder: "string" },
  { matchReg: eval(`/^fs-(italic|oblique|normal|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `font-style: ${val};`, placeholder: "string" },
  { matchReg: eval(`/^italic$/`), wrapper: () => `font-style: italic;`, placeholder: "string" },

  // letter-spacing
  { matchReg: eval(`/^ls-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val, unit = "" }) => `letter-spacing: ${val}${unit};`, placeholder: "string" },
  { matchReg: eval(`/^letter-spacing-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `letter-spacing: ${val};`, placeholder: "string" },

  // line-height 不会缩放
  { matchReg: eval(`/^(line-height|lh)-(${NUMBERS_REG}|${NUMBERS_REG}\\w+|${SEPECIAL_REG})$/`), valIndex: 2, wrapper: ({ val }) => `line-height: ${val};`, placeholder: "string" },

  // color
  { matchReg: eval(`/^color-(${HEX_COLOR_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `color: #${val};`, placeholder: "string" },

  // border radius
  { matchReg: eval(`/^(radius|r)-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), valIndex: 2, wrapper: ({ val, ratio = 1, unit = "" }) => `overflow: hidden; border-radius: ${val * ratio}${unit};`, placeholder: "string" },
  { matchReg: eval(`/^(radius-tl|r-tl)-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), valIndex: 2, wrapper: ({ val, ratio = 1, unit = "" }) => `overflow: hidden; border-top-left-radius: ${val * ratio}${unit};`, placeholder: "string" },
  { matchReg: eval(`/^(radius-tr|r-tr)-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), valIndex: 2, wrapper: ({ val, ratio = 1, unit = "" }) => `overflow: hidden; border-top-right-radius: ${val * ratio}${unit};`, placeholder: "string" },
  { matchReg: eval(`/^(radius-br|r-br)-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), valIndex: 2, wrapper: ({ val, ratio = 1, unit = "" }) => `overflow: hidden; border-bottom-right-radius: ${val * ratio}${unit};`, placeholder: "string" },
  { matchReg: eval(`/^(radius-bl|r-bl)-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), valIndex: 2, wrapper: ({ val, ratio = 1, unit = "" }) => `overflow: hidden; border-bottom-left-radius: ${val * ratio}${unit};`, placeholder: "string" },
  ...
  { matchReg: eval(`/^border-(\\d{1,2}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `border-width: ${val * ratio}${unit};`, placeholder: "string" },
  { matchReg: eval(`/^border-t-(\\d{1,2}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `border-top-width: ${val * ratio}${unit};`, placeholder: "string" },
  { matchReg: eval(`/^border-r-(\\d{1,2}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `border-right-width: ${val * ratio}${unit};`, placeholder: "string" },
  { matchReg: eval(`/^border-b-(\\d{1,2}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `border-bottom-width: ${val * ratio}${unit};`, placeholder: "string" },
  { matchReg: eval(`/^border-l-(\\d{1,2}|${SEPECIAL_REG})$/`), wrapper: ({ val, ratio = 1, unit = "" }) => `border-left-width: ${val * ratio}${unit};`, placeholder: "string" },
  ...
  // opacity 0~100
  { matchReg: eval(`/^opacity-(${NUMBERS_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `opacity: ${val / 100};`, placeholder: "string" },

  // cursor 太多了直接写
  { matchReg: eval(`/^cursor-(\\w+|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `cursor: ${val};`, placeholder: "string" },
  ...
  // user select
  { matchReg: eval(`/^select-(none|auto|text|contain|all|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `user-select: ${val};`, placeholder: "string" },

  // list style type
  { matchReg: eval(`/^list-(none|disc|circle|square|decimal|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `list-style-type: ${val};`, placeholder: "string" },

  // list style position
  { matchReg: eval(`/^list-(inside|outsidel)$/`), wrapper: ({ val }) => `list-style-position: ${val};`, placeholder: "string" },

  // text align
  { matchReg: eval(`/^text-(left|right|center|justify|justify-all|start|end|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `text-align: ${val};`, placeholder: "string" },
  ...
  { matchReg: eval(`/^decoration-(none|underline|overline|line-through|blink|unset|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `text-decoration-line: ${val};`, placeholder: "string" },
  ...
  { matchReg: eval(`/^decoration-(${HEX_COLOR_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `text-decoration-color: #${val};`, placeholder: "string" },
  ...
  // 背景颜色
  { matchReg: eval(`/^bg-(${HEX_COLOR_REG}|${SEPECIAL_REG})$/`), wrapper: ({ val }) => `background-color: #${val};`, placeholder: "string" },

  // shadow
  // { matchReg: eval(`/^shadow-(${HEX_COLOR_REG}\_?)$/`), wrapper: ({ val }) => `background-color: ${val};`, placeholder: "string" },
...
module.exports = { classNameMapper, SEPECIAL_REG }
