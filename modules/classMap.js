...
const classMap = new Map([
  ["m", { styleName: "margin", hasUnit: true, valType: "classNameValue", placeholder: "Number", accept: [Number] }],
  ["mt", { styleName: "margin-top", hasUnit: true, valType: "classNameValue", placeholder: "Number", accept: [Number] }],
  ...
  ["pr", { styleName: "padding-right", hasUnit: true, valType: "classNameValue", placeholder: "Number", accept: [Number] }],
  ["pb", { styleName: "padding-bottom", hasUnit: true, valType: "classNameValue", placeholder: "Number", accept: [Number] }],
  ["pl", { styleName: "padding-left", hasUnit: true, valType: "classNameValue", placeholder: "Number", accept: [Number] }],

  ["top", { styleName: "top", hasUnit: true, valType: "classNameValue", placeholder: "Number", accept: [Number] }],
  ["right", { styleName: "right", hasUnit: true, valType: "classNameValue", placeholder: "Number", accept: [Number] }],
  ["bottom", { styleName: "bottom", hasUnit: true, valType: "classNameValue", placeholder: "Number", accept: [Number] }],
  ["left", { styleName: "left", hasUnit: true, valType: "classNameValue", placeholder: "Number", accept: [Number] }],
